        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-start">
          <div className="space-y-5 text-lg leading-relaxed text-muted">
            <p>
              ...
              thoughtful, community-minded, and comfortable sharing space with
              others doing meaningful work.
            </p>
            <p>
          ...
          <aside className="rounded-xl border border-accent/20 bg-parchment p-8 shadow-sm">
            ...
            <a
              href="#contact"
              className="mt-8 inline-flex min-h-12 w-full items-center justify-center rounded-md bg-accent text-base font-medium text-cream transition-opacity hover:opacity-90"
            >
