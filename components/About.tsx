      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-5 text-lg leading-relaxed text-muted">
          ...
          <p>
            ...
            games within reach, seating arranged for real discussion, and space
            for guests who pass through Philadelphia. More detail about our
            mission and programming will land here as the community takes shape.
          </p>
        </div>
      </div>
    </section>
